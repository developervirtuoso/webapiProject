...
/**
 * Servlet implementation class TestReportPoi
 */
@WebServlet("/TestReportPoi")
public class TestReportPoi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TestReportPoi() {
        super();
	...
	String Filename="SmppReport"+requested_date+".xlsx";
       ...
       /* Object[][] datatypes = {
        ...
        smpp_dao.all_users_count(requested_date,jsonArray,companyname1);
        smpp_dao.getTesyncDbData(jsonArray1,requested_date,companyname1);
        smpp_dao.all_users_countSpanel(requested_date,jsonArray2,companyname1);
	 ...
	 for(int i=0; i<jsonArray1.length();i++){
  	...
  	for(int i=0; i<jsonArray2.length();i++){
		 ...
		 j++;
			try{
				JSONObject showdata=jsonArray2.getJSONObject(i);
				String current_companyname = showdata.getString("companyname");
				 int sub_count = Integer.parseInt(showdata.getString("submitted_count"));
				 int del_count = Integer.parseInt(showdata.getString("submitted_count"));

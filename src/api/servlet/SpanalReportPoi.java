...
/**
 * Servlet implementation class SpanalReportPoi
 */
@WebServlet("/SpanalReportPoi")
public class SpanalReportPoi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SpanalReportPoi() {
        super();
	...
	String Filename="SPanelReport"+requested_date+".xlsx";
       ...
       /* Object[][] datatypes = {
        ...
        smpp_dao.all_users_countSpanel(requested_date,jsonArray,"");
